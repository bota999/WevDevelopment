...
from .views.cbv import TaskListListCreate, TaskListDetailUpdateDelete, TaskListCreate, \
    TaskDetailUpdateDelete
from .views.fbv import task_lists_list, task_list_detail, task_detail, tasks_list
from .views.authorization import Register
